...
import ProductCard from '@/components/molecules/ProductCard.vue'; // Import ProductCard
...
// Default ProductList story with mocked products
  ...
  render: (args) => ({
    ...
    render() {
      return h(ProductList, {
        products: mockProducts, // Pass mock data to the ProductList component
      });
    },
  }),
  args: {},
